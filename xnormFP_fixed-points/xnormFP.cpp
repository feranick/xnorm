...
//		Xnorm							 
//														 
//		v. 4.4-Fix-point - 20160922
//
//		2007-2016 - Nicola Ferralis
//                                                        
...
int operate(unsigned long points, char *namein);
int ReadKey();
float ReadKeyF();
...
int main(int argc, char *argv[])
{
    ...
    if(argc<3)
	{cout<< "\n xnormFP v."<<version<< "\n\n";
        cout<< " Usage:\n xnorm <number of points> <filename>\n\n";
        }
    
    if(argc>=3)
	{  operate(atoi(argv[1]), argv[2]);
        return 0;
    }
}
